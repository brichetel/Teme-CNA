...
public final class PersonServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Person.DataRequest,
      proto.Person.DataResponse> getGetDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getData",
      requestType = proto.Person.DataRequest.class,
      responseType = proto.Person.DataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Person.DataRequest,
      proto.Person.DataResponse> getGetDataMethod() {
    io.grpc.MethodDescriptor<proto.Person.DataRequest, proto.Person.DataResponse> getGetDataMethod;
    if ((getGetDataMethod = PersonServiceGrpc.getGetDataMethod) == null) {
      synchronized (PersonServiceGrpc.class) {
        if ((getGetDataMethod = PersonServiceGrpc.getGetDataMethod) == null) {
          PersonServiceGrpc.getGetDataMethod = getGetDataMethod = 
              io.grpc.MethodDescriptor.<proto.Person.DataRequest, proto.Person.DataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "PersonService", "getData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Person.DataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Person.DataResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new PersonServiceMethodDescriptorSupplier("getData"))
                  .build();
          }
        }
     }
  ...
  public static abstract class PersonServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getData(proto.Person.DataRequest request,
        io.grpc.stub.StreamObserver<proto.Person.DataResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proto.Person.DataRequest,
                proto.Person.DataResponse>(
  ...
  public static final class PersonServiceBlockingStub extends io.grpc.stub.AbstractStub<PersonServiceBlockingStub> {
    ...
    /**
     */
    public proto.Person.DataResponse getData(proto.Person.DataRequest request) {
  ...
  public static final class PersonServiceFutureStub extends io.grpc.stub.AbstractStub<PersonServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Person.DataResponse> getData(
        proto.Person.DataRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATA:
          serviceImpl.getData((proto.Person.DataRequest) request,
              (io.grpc.stub.StreamObserver<proto.Person.DataResponse>) responseObserver);
          break;
        default:
