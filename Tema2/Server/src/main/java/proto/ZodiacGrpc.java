...
public final class ZodiacGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<proto.ZodiacOuterClass.DataRequest,
      proto.ZodiacOuterClass.DataResponse> getGetDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getData",
      requestType = proto.ZodiacOuterClass.DataRequest.class,
      responseType = proto.ZodiacOuterClass.DataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.ZodiacOuterClass.DataRequest,
      proto.ZodiacOuterClass.DataResponse> getGetDataMethod() {
    io.grpc.MethodDescriptor<proto.ZodiacOuterClass.DataRequest, proto.ZodiacOuterClass.DataResponse> getGetDataMethod;
    if ((getGetDataMethod = ZodiacGrpc.getGetDataMethod) == null) {
      synchronized (ZodiacGrpc.class) {
        if ((getGetDataMethod = ZodiacGrpc.getGetDataMethod) == null) {
          ZodiacGrpc.getGetDataMethod = getGetDataMethod = 
              io.grpc.MethodDescriptor.<proto.ZodiacOuterClass.DataRequest, proto.ZodiacOuterClass.DataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Zodiac", "getData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.ZodiacOuterClass.DataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.ZodiacOuterClass.DataResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new ZodiacMethodDescriptorSupplier("getData"))
                  .build();
          }
        }
     }
  ...
  public static abstract class ZodiacImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getData(proto.ZodiacOuterClass.DataRequest request,
        io.grpc.stub.StreamObserver<proto.ZodiacOuterClass.DataResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proto.ZodiacOuterClass.DataRequest,
                proto.ZodiacOuterClass.DataResponse>(
  ...
  public static final class ZodiacBlockingStub extends io.grpc.stub.AbstractStub<ZodiacBlockingStub> {
    ...
    /**
     */
    public proto.ZodiacOuterClass.DataResponse getData(proto.ZodiacOuterClass.DataRequest request) {
  ...
  public static final class ZodiacFutureStub extends io.grpc.stub.AbstractStub<ZodiacFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.ZodiacOuterClass.DataResponse> getData(
        proto.ZodiacOuterClass.DataRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATA:
          serviceImpl.getData((proto.ZodiacOuterClass.DataRequest) request,
              (io.grpc.stub.StreamObserver<proto.ZodiacOuterClass.DataResponse>) responseObserver);
          break;
        default:
